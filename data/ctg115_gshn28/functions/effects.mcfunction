...
execute if entity @s[tag=!ctg_stop,tag=ctg_reverse,scores={ctg_timer=..-1}] run item replace entity @e[type=armor_stand,name="ctg_wheelsvan",distance=..1] armor.head with wooden_hoe{CustomModelData: 42}
...
execute if entity @s[tag=!ctg_stop,tag=!ctg_reverse,scores={ctg_timer=..-1}] run item replace entity @e[type=armor_stand,name="ctg_wheelsvan",distance=..1] armor.head with wooden_hoe{CustomModelData: 40}
...
execute if entity @s[tag=ctg_stop,scores={ctg_timer=1..}] run item replace entity @e[type=armor_stand,name="ctg_wheelsvan",distance=..1] armor.head with wooden_hoe{CustomModelData: 41}
execute if entity @s[tag=ctg_stop,scores={ctg_timer=1..}] run scoreboard players set @s ctg_timer 0
